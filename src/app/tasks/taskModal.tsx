...
interface TaskModalProps {
  ...
  onSave: (data: Omit<Task, "id_task" | "id_user">) => void;
}
...
const taskSchema = z.object({
  ...
  description: z.string("Insira description").min(10, {
                ...
                render={({ field }) => (
                  <Select value={field.value} onValueChange={field.onChange}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="E">Em andamento</SelectItem>
                      <SelectItem value="C">Comcluída</SelectItem>
                    </SelectContent>
                  </Select>
                )}
              />
